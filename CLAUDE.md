...
| Tier | 컴포넌트 (사용 횟수) | 상태 |
|---|---|---|
| 🔴 핵심 (10+) | **UiButton (71)**, **UiInput (46)**, **UiSelect (32)**, **UiModal (31)**, UiTextarea (20), **UiEmpty (22)** ✅, UiToggle (15), **UiLoading (13)** ✅, UiCheckbox (13), **UiBadge (10)** ✅ | UiButton/UiInput/UiSelect/UiModal/UiEmpty/UiBadge/UiLoading ✅ 완료 · 3개 남음 |
